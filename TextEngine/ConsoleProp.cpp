...
int ConsoleProp::GetStartX()
{
	return _StartX;
}

int ConsoleProp::GetStartY()
{
	return _StartY;
}

int ConsoleProp::GetCurrentY()
{
	return _CurrentY;
}
...
int ConsoleProp::GetFontY()
{
	return _FontY;
}

int ConsoleProp::GetColour()
{
	return _Colour;
}

int ConsoleProp::GetPrevColour()
{
	return _PrevColour;
}

void ConsoleProp::SetCurrentY(int CurrentY)
{
	_CurrentY = CurrentY;
}

int ConsoleProp::GetConsoleWidth()
{
	return _Width;
}
...
void ConsoleProp::SetPrevColour(unsigned short Colour)
{
	_PrevColour = Colour;
}
